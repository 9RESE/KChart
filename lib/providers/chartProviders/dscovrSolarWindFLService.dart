...
class DscovrSolarWindService extends ChangeNotifier {
  List<DscovrSolarMagSeries> _magSeries = [];
  List<DscovrSolarWindSeries> _windSeries = [];
  ...
  String magSatellite = "DSCOVR";
  String windSatellite = "DSCOVR";
  ...
  initData() async {
    ...
    _btChartsData = [];
    _bzChartsData = [];
    _magSeries = await ApiHelper.getDscovrMagSeries();
    _windSeries = await ApiHelper.getDscovrWindSeries();
        ...
        getTouchedSpotIndicator:
          ...
          return spotIndexes.map((spotIndex) {
            return TouchedSpotIndicatorData(
              FlLine(color: Colors.white, strokeWidth: .5),
              FlDotData(
        ...
        leftTitles: AxisTitles(
            ...
            axisNameWidget: RichText(
              text: const TextSpan(children: [
                TextSpan(text: 'Bt', style: TextStyle(color: Colors.yellow)),
                TextSpan(
                    text: ' Bz GSM(nT)', style: TextStyle(color: Colors.red)),
              ]),
            ),
            sideTitles: SideTitles(
  ...
  LineChartData phiData() {
    return LineChartData(
      ...
      borderData: _borderData,
      lineBarsData: [_phiLineChartData],
      // minX: _mh
    );
  }
  ...
  LineChartData densityData() {
    return LineChartData(
      ...
      borderData: _borderData,
      lineBarsData: [_densityLineChartData],
      // minX: _mh
    );
  }
  ...
  LineChartData speedData() {
    return LineChartData(
      ...
      borderData: _borderData,
      lineBarsData: [_speedLineChartData],
      // minX: _mh
    );
  }
  ...
  LineChartData tempData() {
    return LineChartData(
      ...
      borderData: _borderData,
      lineBarsData: [_tempLineChartData],
      // minX: _mh
    );
  }
  ...
  _drawIndicators(FlTouchEvent event, LineTouchResponse? lineTouch) {
    ...
    _btzIndicators = [
      ShowingTooltipIndicators([
        LineBarSpot(_btLineChartData, 0, FlSpot(value, _btY)),
        LineBarSpot(_bzLineChartData, 1, FlSpot(value, _bzY))
      ]),
    ];
    notifyListeners();
  }
