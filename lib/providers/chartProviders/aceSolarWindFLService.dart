...
class AceSolarWindFlService extends ChangeNotifier {
  List<AceSolarMagSeries> _magSeries = [];
  List<AceSolarWindSeries> _windSeries = [];
  ...
  String magSatellite = "ACE";
  String windSatellite = "ACE";
  ...
  initData() async {
    ...
    _btChartsData = [];
    _bzChartsData = [];
    _magSeries = await ApiHelper.getAceMagSeries();
    _windSeries = await ApiHelper.getAceWindSeries();
